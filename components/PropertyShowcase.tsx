...
const PropertyShowcase: React.FC<PropertyShowcaseProps> = ({ onPropertySelect }) => {
  ...
  return (
    <section id="properties" ref={targetRef} className="relative h-[400vh] bg-white text-charcoal-900">
      <div className="sticky top-0 flex h-screen items-center overflow-hidden">
        ...
        <motion.div style={{ x }} className="flex gap-20 px-6 md:px-24 items-center pt-32">
          ...
          {/* End Card - scrolls to PropertyGrid */}
          <button
            type="button"
          ...
          >
            ...
            <p className="mt-8 font-serif text-3xl text-charcoal-900">View more</p>
          </button>
        </motion.div>
      </div>
    </section>
